program p1cEjercicio2;
type
no = -1..10;
var
nots : no;
legajo,i,ingTot,recTot: integer;
cond: String;
begin
nots:=0;
ingTot:=0;
...
writeln('La cantidad de alumnos ingresantes total',ingTot);
writeln('La cantidad de alumnos recursantes total',recTot);
